...
cl = LINETCR.LINE()
cl.login(token="EobkYCoetRH9teG0X2Q2.O5hNm5ogBZky9G/e5Ds/8G.CpoTB36O/9BM910PLSKK/Wb5duBpQhKz2+Zi+M2tngY=")
cl.loginResult()
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"นี่คือข้อความตอบกลับอัตโนมัติ ขอบคุณที่เพิ่มฉันเป็นเพื่อน",
    "lang":"JP",
    "comment":"สวัสดีครับ",
    "commentOn":False,
    "commentBlack":{},
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ua391e73393866f3298f60f84e5d4bef2"}
                cl.sendMessage(msg)
...
#==============================================================================#
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,"รฆโ€นโ€รงยป๏ฟฝรคยบโ€ รฅโ€ฆยจรฉฦ’ยจรงลกโ€รฉโ€โฌรจยฏยทรฃโฌโ€")
